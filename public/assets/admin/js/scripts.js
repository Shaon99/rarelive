...
let isSoundOn = localStorage.getItem("soundPreference") === "on";

// Update the toggle switch based on the saved preference
function initializeToggle() {
  $("#toggle-sound").prop("checked", isSoundOn); // Set checkbox state
}


$("#toggle-sound").on("change", function () {
  isSoundOn = $(this).is(":checked"); // Get checkbox state
  localStorage.setItem("soundPreference", isSoundOn ? "on" : "off"); // Save preference
});
...
$(function () {
  ...
  $(".needs-validation").submit(function (event) {
    ...
    if (form[0].checkValidity() === false) {
      ...
      submitButton.addClass('btn-progress').prop('disabled', true);
    }
