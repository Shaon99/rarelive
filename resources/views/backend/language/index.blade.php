                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <button class="btn btn-primary add btn-icon icon-left"><i
                                    class="fas fa-plus-circle"></i>{{ __('Create Language') }}</button>
                        </div>
                        <div class="card-body">
